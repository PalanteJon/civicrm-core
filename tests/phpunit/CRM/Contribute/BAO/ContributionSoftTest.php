...
class CRM_Contribute_BAO_ContributionSoftTest extends CiviUnitTestCase {
  ...
  public function testGetSoftContributionTotals() {
    ...
    $this->assertEquals(2, $totals[0], 'test count of completed soft credits');
    $this->assertEquals(0, $totals[1], 'test count of cancelled soft credits');
    ...
    $totals = CRM_Contribute_BAO_ContributionSoft::getSoftContributionTotals($crediteeId);
    $this->assertEquals(1, $totals[0], 'test count of completed soft credits');
    $this->assertEquals(0, $totals[1], 'test count of cancelled soft credits');
